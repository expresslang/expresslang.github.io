...
const languageMeta: Record<string, { iso: string; color: string }> = {
  express: { iso: 'ISO 10303-11:2004', color: 'text-[#e99262]' },
  'express-g': { iso: 'ISO 10303-11:2004', color: 'text-[#4ec0aa]' },
  'express-i': { iso: 'ISO 10303-12', color: 'text-[#d85577]' },
  'express-x': { iso: 'ISO 10303-14', color: 'text-[#077783]' },
}
      ...
      <div class="bg-gradient-to-b from-slate-50 to-white dark:from-navy dark:to-navy-light/30 pt-12 pb-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div v-if="meta" class="mb-4">
            <h1 :class="['font-logo font-bold text-3xl sm:text-4xl leading-tight', meta.color]">{{ content.title }}</h1>
            ...
            <div class="sticky top-24 space-y-1">
              ...
              <RouterLink
                ...
                :class="[
                  ...
                  sib.slug === slug
                    ? 'text-elf-blue dark:text-elf-blue bg-elf-blue/8 dark:bg-elf-blue/8 font-medium'
