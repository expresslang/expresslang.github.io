...
starting date corresponds to Thursday 19 July, 622 AD.
...
Years are counted since the Creation and written as 1993 AM _(anno
mundi)_. In the Gregorian calendar,
and Monday 7 October 3761 BC at 11 hours and eleven and one third
minutes PM.
...
earlier in EXPRESS# and [.small]#EXPRESS-G forms.
